...
-- Dumping data for table `azou`
CREATE TABLE `azou` (`id` INTEGER PRIMARY KEY, `name` TEXT);
...
INSERT INTO `users` (`id`, `name`, `password`, `role`, `age`, `phone`, `email`, `city`, `availability`, `team`, `active`) VALUES ('2', 'ARAAR ZINEB', '$2b$10$kQg7vpiL0gn0qzkSIsPVqufmC3fYoBoF8iQLM0ziHPmxQ134BvpVi', 'supervisor', '25', '+213698282788', 'zeineb.ara@gmail.com', 'Montreal', '0', 'none', '1');
...
INSERT INTO `sqlite_sequence` (`name`, `seq`) VALUES ('query', '4');
...
INSERT INTO `team` (`id`, `name`, `prod_line`, `supervisor`) VALUES ('222', 'Team 1', 'null', 'zeineb.ara@gmail.com');
INSERT INTO `azou` (`id`, `name`) VALUES ('0', 'azou');
INSERT INTO `query` (`id`, `name`, `sqlstatement`) VALUES ('3', 'test', 'select * from team;');
INSERT INTO `query` (`id`, `name`, `sqlstatement`) VALUES ('4', 'azou', 'select * from team;');
...
INSERT INTO `machinealerts` (`id`, `machine`, `cause`, `degree`, `status`, `supervisor`, `employee`, `date`) VALUES ('2', 'HM99', 'None', 'Risque', 'waiting', 'zeineb.ara@gmail.com', 'none', '2024-05-14 10:48:14');
...
INSERT INTO `machinealerts` (`id`, `machine`, `cause`, `degree`, `status`, `supervisor`, `employee`, `date`) VALUES ('7', 'HM12', 'None', 'Risque', 'waiting', 'yasmine@gmail.com', 'none', '2024-05-14 10:48:14');
