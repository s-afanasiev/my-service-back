...
function populateSidebar(tables) {
  ...
  tablesContainer.classList.add("tables_container");
  ...
  const tableDivEnd = document.createElement("div");
  tableDivEnd.classList.add("sidebar_table_div_end");
  tablesContainer.appendChild(tableDivEnd);

  sidebar.appendChild(tablesContainer);

  const tableDivs = document.querySelectorAll(".sidebar_table_div");
  tableDivs.forEach((div) => {
    div.addEventListener("click", function () {
      tablename = this.querySelector("button").textContent;
...
function displayTableData(data) {
  ...
  tableTitle.classList.add("table_title");
  ...
  if (data.length > 0) {
    ...
    h1.src = "/img/no_data_available.png";
    h1.classList.add("no_data_img");
